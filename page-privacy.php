...
<main>
    ...
    <div class="content-section">
        <div class="container">
            ...
            <ul>
                <li><strong>Account Information:</strong> Name, email address, password, profile picture, and date of birth</li>
                <li><strong>Educational Information:</strong> Course enrollment, progress data, quiz and exam results, assignments, and certificates earned</li>
            ...
            <ul>
                ...
                <li>To process payments and manage course enrollments</li>
                <li>To communicate with you about courses, updates, and support</li>
                <li>To generate certificates and maintain educational records</li>
            ...
            <ul>
                <li><strong>With Instructors:</strong> Your course progress and assignment submissions are visible to instructors teaching your enrolled courses</li>
                <li><strong>Service Providers:</strong> We work with third-party service providers for payment processing, email delivery, hosting, and analytics</li>
