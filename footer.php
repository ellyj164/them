        ...
        <div class="container">
            <div class="footer-content">
                ...
                <div class="footer-column">
                    ...
                    <p><a href="mailto:contact@frenchpracticehub.com">contact@frenchpracticehub.com</a></p>
                    <p><a href="tel:+250787550062">+250 787 550 062</a></p>
                </div>
                ...
                <div class="footer-column">
                    ...
                    <div class="social-icons">
                        <!-- YouTube -->
                        <a href="https://www.youtube.com/@fidelefle" target="_blank" rel="noopener noreferrer" class="social-icon social-youtube" aria-label="YouTube">
                        ...
                        <!-- Facebook -->
                        <a href="https://www.facebook.com/fidelefle" target="_blank" rel="noopener noreferrer" class="social-icon social-facebook" aria-label="Facebook">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <!-- Instagram -->
                        <a href="https://www.instagram.com/eidotrailrunningworld/?utm_source=qr&amp;r=nametag" target="_blank" rel="noopener noreferrer" class="social-icon social-instagram" aria-label="Instagram">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <!-- TikTok -->
                        <a href="https://www.tiktok.com/@fidele.fle" target="_blank" rel="noopener noreferrer" class="social-icon social-tiktok" aria-label="TikTok">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <!-- LinkedIn -->
                        <a href="https://www.linkedin.com/in/fidelefle" target="_blank" rel="noopener noreferrer" class="social-icon social-linkedin" aria-label="LinkedIn">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <!-- Twitter/X -->
                        <a href="https://x.com/FleFidele" target="_blank" rel="noopener noreferrer" class="social-icon social-twitter" aria-label="Twitter">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <!-- WhatsApp -->
                        <a href="https://api.whatsapp.com/message/J7DK6KO6NLE4I1?autoload=1&amp;app_absent=0" target="_blank" rel="noopener noreferrer" class="social-icon social-whatsapp" aria-label="WhatsApp">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <!-- Email -->
                        <a href="mailto:contact@frenchpracticehub.com" class="social-icon social-email" aria-label="Email">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
